...
/* Create a React web application that consumes the https://fakestoreapi.com/carts/2 API and displays a list of products in the cart. 
 For each product in the cart, the application should make an API call to fetch the product details
 using the ID returned in the cart API and display the product title, price, and image. 
 Note: The https://fakestoreapi.com/products/:id: API returns details for a single product. 
